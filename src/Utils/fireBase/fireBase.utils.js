//Those utilities are the layer between the frontend and these additional library
...
//There are different providers github, facbook ,...
const googleProvider  = new GoogleAuthProvider();

googleProvider.setCustomParameters({
  // EVERY TIME THE USER INTERACTS IT FORCES TO SELECT ACCOUNT
